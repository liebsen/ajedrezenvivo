  ...
  export default {
    ...
    methods: {
      play: function(player){
        var t = this
        const template = (`<div class="content"><h3><span class="icon"><span class="fas fa-stopwatch"></span></span></h3><div class="content dialog-invite"><div><input type="radio" class="is-checkradio has-background-color is-success" name="clock" id="min10" value="10" checked><label for="min10">10'</label></div><div><input type="radio" class="is-checkradio has-background-color is-success" name="clock" id="min5" value="5"><label for="min5">5'</label></div><div><input type="radio" class="is-checkradio has-background-color is-success" name="clock" id="min3" value="3"><label for="min3">3' min'</label></div></div></div>`);
        swal({
